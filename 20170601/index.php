...
<div class="rule zm-customer-confirm hide">
    ...
    <ul>
        ...
        <li><span>3.</span>完成申请后请及时前往“我的奖品”，通过“福利金”或“京东卡”奖品填写支付宝和手机号，该信息填写一次即可；</li>
        <li><span>4.</span>如未找到奖品，iOS用户可前往我的-头像-收货信息以完成填写，安卓用户则可更新至最新版本即可发现奖品；</li>
        <li><span>5.</span>本次活动仅限之前未成功申请过该业务的用户，且同一用户不可重复领取同一奖励，活动权益需在7月10日24时前完成领取，过期自动失效；</li>
