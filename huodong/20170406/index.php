    ...
    <body>
        <div class="wrap hide">
            <div class="content">
                ...
                <img id="bgImg" data-src="<?php echo $imgUrl; ?>bg1.png">
                ...
                <div class="ticket left1">
                     <div class="ticketTop Img200"><img data-src="<?php echo $imgUrl ?>ticketTop_200new.png"></div>
                     <img id="imgId_200" bp="200yuan" title="200yuan" data-src="<?php echo $imgUrl ?>do.png">
                </div> 
                <div class="ticket left2">
                     <div class="ticketTop Img200"><img data-src="<?php echo $imgUrl ?>ticketTop_100new.png"></div>
                     <img id="imgId_100" bp="100yuan" title="100yuan" data-src="<?php echo $imgUrl ?>do.png">
                </div> 
                <div class="ticket left3">
                     <div class="ticketTop Img200"><img data-src="<?php echo $imgUrl ?>ticketTop_50new.png"></div>
                     <img id="imgId_50" bp="50yuan" title="50yuan" data-src="<?php echo $imgUrl ?>do.png">
                </div>  
                ...
                <div id="scratch" bp="guajiang-wrap" title="guajiang-wrap">
                    <div id="card" bp="guajiang2" title="guajiang2"></div>
                    <div id="start" bp="guajiang1" title="guajiang1"></div>
                </div>
        ...
        <div class="rule zm-customer-confirm hide">
            <h6>活动规则</h6>
            <ul>
                <li><span>1.</span>活动为周三00：00-24：00全天举行，秒券10点开始，秒完即止，券可用于活动全场业务。积分抽券全天可参与，5积分抽1次。</li>
