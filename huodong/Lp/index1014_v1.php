...
<body>
    <div class="container">
        <div class="banner-part-one">
            <img class="bg" src="http://r.51gjj.com/act/images/20161014_market_downbg_one.jpg" alt="bg">
            <div class="btn-down">
                <a href="javascript:;" id="appAddr"></a>
            </div>
        </div>
        <div class="banner-part-two">
            <img class="bg" src="http://r.51gjj.com/act/images/20161014_market_downbg_two_new1.jpg" alt="bg">
        </div>
        <div class="cnzz">
        ...
        <div class="bottom-float">
            <a class="bottom-down-app" href="javascript:;">下载51公积金APP</a>
        </div>
    </div>
    <script>
    //判断渠道
    ...
    document.getElementsByClassName("bottom-down-app")[0].onclick = function() {
        _czc.push(['_trackEvent', 'page', 'db', appAddr.href.substr(27, 20), '1', 'appAddr']);
