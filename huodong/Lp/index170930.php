        ...
        <div class="box">
            <div class="section section-one">
                <div class="banner-part-one">
                    <img class="bg" src="//r.51gjj.com/act/release/img/20170930_bbqb_bg.png" alt="bg">
                </div>
                <div class="user-info">
...
<!--                     <div class="prompt">
                ...
                <div class="bottom-info">厦门零点花金融信息服务有限公司</div>
                <div class="cnzz">
    ...
    <script src="js/main_v3.js?v=<?php echo $version; ?>"></script>
    <script>
        //判断渠道
        function is_weixn() {
