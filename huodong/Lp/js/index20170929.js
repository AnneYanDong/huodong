var init = {
    fn: function() {
        //index170929.html
        this.searchClick("https://itunes.apple.com/us/app/51gong-ji-jin-guan-jia-zhu/id908573399?ls=1&mt=8",'http://apk.51gjj.com/51gjj_' + place_name + '.apk');
        this.getCode("https://itunes.apple.com/us/app/51gong-ji-jin-guan-jia-zhu/id908573399?ls=1&mt=8",'http://apk.51gjj.com/51gjj_' + place_name + '.apk');
        //index170929_2.html
    ...
    //点击查询,注册后跳链接的
    searchClick: function(iosLink,androidLink) {
        var _this = this;
        var skipTimer = null;
