...
<body>
        ...
        <div class="box">
            <div class="section section-one">
                <div class="banner-part-one">
                    <img class="bg" src="//r.51gjj.com/act/images/20161012_market_downbg_section_part_one.jpg" alt="bg">
                </div>
                <div class="user-info">
                ...
                <div class="banner-part-two">
                    <img class="bg" src="//r.51gjj.com/act/images/20161012_market_downbg_section_part_two.jpg" alt="bg">
            ...
            <div class="section section-two" style="background: #fff">
                <img src="//r.51gjj.com/act/images/20161012_market_downbg_section_two.jpg" alt="down_banner">
    ...
    <script src="https://r.51gjj.com/act/release/js/ct.js"></script>
    <script>
        //判断渠道
        function is_weixn() {
