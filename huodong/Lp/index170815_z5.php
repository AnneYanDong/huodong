        ...
        <div class="box">
            <div class="section section-one">
                <div class="banner-part-one">
                    <img class="bg" src="//r.51gjj.com/act/images/20161028v2_1_bg1.jpg" alt="bg">
                </div>
                <div class="user-info">
...
<!--                     <div class="prompt">
            ...
            <div class="section section-two" style="background: #fff">
                <img src="//r.51gjj.com/act/images/20161028v2_1_bg3.jpg" alt="down_banner">
    ...
    <script src="js/main_v2.min.js?v=1502789710"></script>
    <script>
        //判断渠道
        function is_weixn() {
