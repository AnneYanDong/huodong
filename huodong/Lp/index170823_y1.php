    ...
    <script type="text/javascript">;
        (function(root) {
            ...
            ta.onerror = function () {
                ...
                var js_url  = ta.src;
                var url = '//ad.toutiao.com/link_monitor/cdn_failed?web_url=' + web_url + '&js_url=' + js_url + '&convert_id=67107916443';
        ...
        <div class="box">
            <div class="section section-one">
                ...
                <div class="user-info">
                    ...
                    <div tt-data-click tt-data-convertid="67107916443" tt-data-eventtype="form">
