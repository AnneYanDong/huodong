    ...
    <script type="text/javascript">;
        (function(root) {
            ...
            ta.onerror = function () {
                ...
                var web_url = window.encodeURIComponent(window.location.href);
                var js_url  = ta.src;
                var url = '//ad.toutiao.com/link_monitor/cdn_failed?web_url=' + web_url + '&js_url=' + js_url + '&convert_id=59717494405';
                request.open('GET', url, true);
                request.send(null);
            }
...
<body>
    <div class="container">
        ...
        <div tt-data-click tt-data-convertid="59717494405" tt-data-eventtype="form"></div>
    </div>
    <script>
    //判断渠道
    function is_weixn() {
    ...
    if (is_weixn()) {
        ...
        if (browser.versions.ios || browser.versions.iPhone || browser.versions.iPad) {
            ...
            appAddr.href = "iOS：https://lnk0.com/gMxJR1";
        } else {
